---
title:: Email Traffic Economics: Calculating Cost Per Subscriber and Breakeven Thresholds
description:: Email subscribers cost $2-$12 to acquire. Learn how to calculate true CPS, model breakeven timelines, and determine when list growth becomes profitable.
focus_keyword:: email traffic economics subscriber cost
...
- [Cost Per Subscriber (CPS) Formula](#cost-per-subscriber-cps-formula)
- [CPS by Acquisition Channel](#cps-by-acquisition-channel)
- [Subscriber Lifetime Value (LTV) Benchmarks](#subscriber-lifetime-value-ltv-benchmarks)
- [Breakeven Analysis](#breakeven-analysis)
- [Optimizing CPS by Channel](#optimizing-cps-by-channel)
- [Case Study: Publisher Reduces CPS from $9.40 to $2.10](#case-study-publisher-reduces-cps-from-9-40-to-2-10)
- [Tools for CPS Tracking](#tools-for-cps-tracking)
...
**Minimum**: **LTV ≥ 3x CPS** (profitable)
**Healthy**: **LTV ≥ 5x CPS** (sustainable growth)
**Excellent**: **LTV ≥ 10x CPS** (high-efficiency)
...
- **[Google Analytics 4](https://analytics.google.com)**: Goal tracking for signups (free)
- **[ConvertKit](https://convertkit.com)**: Subscriber source tracking (free <1K subs)
- **[Unbounce](https://unbounce.com)**: Landing page A/B testing ($90/month+)
- **[SparkLoop](https://sparkloop.app)**: Referral program tracking ($50/month+)
- **[Google Sheets](https://sheets.google.com)**: Custom CPS dashboard (free)

Self-hosted: **[Plausible Analytics](https://plausible.io)** (open-source, privacy-focused, goal tracking).
...
**Q: What's a "good" CPS for publishers?**
**<$3.00** for ad-based monetization. **<$8.00** for paid newsletters. **<$15** for SaaS/ecommerce.

**Q: Should I pause list growth if CPS > LTV?**
Not immediately. **SEO-driven growth** has **12-24 month payback** but becomes profitable long-term. Pause **paid ads** if underwater.

**Q: How do I calculate CPS for organic (non-paid) channels?**
Include **content production costs** + **time cost** + **tool costs**. Divide by new subscribers.

**Q: Can I amortize lead magnet creation over 12 months?**
Yes, if the lead magnet is evergreen (reused for 12+ months). Example: $600 ebook ÷ 12 months = $50/month.

**Q: What if my subscribers come from multiple channels?**
Calculate **CPS per channel** (not blended). Example: SEO subscribers cost $1.20, paid social cost $6.80. Track separately to optimize spend.
...
**Next steps**: Calculate your **CPS by channel** (last 6 months). Calculate **subscriber LTV** (see [email-list-value-calculator](./email-list-value-calculator.md)). If **LTV/CPS < 3x**, either (1) reduce CPS (shift to organic channels) or (2) increase LTV (add affiliates, launch paid tier). Remeasure quarterly.
