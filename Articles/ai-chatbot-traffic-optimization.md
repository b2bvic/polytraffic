...
> **Quick Summary**
> - **What this covers:** AI chatbots are becoming primary search interfaces. Optimize for citation in ChatGPT, Perplexity, Claude, and Gemini by understanding their retrieval mechanisms and content preferences.
> - **Who it's for:** traffic strategists and growth operators
> - **Key takeaway:** Read the first section for the core framework, then use the specific tactics that match your situation.

- [How AI Chatbots Select and Cite Sources](#how-ai-chatbots-select-and-cite-sources)
- [Content Formats That Drive AI Citations](#content-formats-that-drive-ai-citations)
- [Technical Optimization for AI Discovery](#technical-optimization-for-ai-discovery)
- [Measuring and Tracking AI Referral Traffic](#measuring-and-tracking-ai-referral-traffic)
- [Strategic Content Portfolio for AI Visibility](#strategic-content-portfolio-for-ai-visibility)
...
- Includes forums (Reddit, Quora), not publishers
...
* **How AI Chatbots Select and Cite Sources:** AI citation mechanisms differ by model architecture and training data, but share retrieval patterns.
* **Technical Optimization for AI Discovery:** AI retrieval systems crawl and index content differently than Google.
* **Measuring and Tracking AI Referral Traffic:** Traditional analytics tools don't segment AI traffic clearly.
* **Strategic Content Portfolio for AI Visibility:** Optimize content mix to maximize AI citation probability across query types.
