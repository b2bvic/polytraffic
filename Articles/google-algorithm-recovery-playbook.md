...
- [Phase 1: Diagnosis (Days 1-14)](#phase-1-diagnosis-days-1-14)
- [Phase 2: Content Audit and Triage (Days 14-45)](#phase-2-content-audit-and-triage-days-14-45)
- [Phase 3: Technical and Infrastructure (Days 30-60)](#phase-3-technical-and-infrastructure-days-30-60)
- [Phase 4: Rebuilding (Days 45-90+)](#phase-4-rebuilding-days-45-90)
- [Case Study: Recovery Framework in Action](#case-study-recovery-framework-in-action)
- [Recovery Timeline Expectations](#recovery-timeline-expectations)
...
* **Phase 1: Diagnosis (Days 1-14):** The first two weeks determine whether your recovery effort targets the right problem.
* **Phase 2: Content Audit and Triage (Days 14-45):** Export all indexed pages from Google Search Console → Coverage report.
* **Phase 3: Technical and Infrastructure (Days 30-60):** Algorithm updates increasingly incorporate page experience signals.
* **Phase 4: Rebuilding (Days 45-90+):** The content that got penalized tells you what NOT to produce.
* **Case Study: Recovery Framework in Action:** A 400-page affiliate content site in the home improvement niche.
* **Recovery Timeline Expectations:** Based on Search Engine Journal analysis and practitioner reporting:
