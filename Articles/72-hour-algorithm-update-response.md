...
> **Quick Summary**
> - **What this covers:** When Google updates hit, the first 72 hours determine recovery trajectory. Deploy this evidence-based protocol to diagnose impact, triage pages, and execute recovery before competitors adapt.
> - **Who it's for:** traffic strategists and growth operators
> - **Key takeaway:** Read the first section for the core framework, then use the specific tactics that match your situation.

- [Hour 0-6: Detection and Impact Quantification](#hour-0-6-detection-and-impact-quantification)
- [Hour 6-24: Root Cause Hypothesis Formation](#hour-6-24-root-cause-hypothesis-formation)
- [Hour 24-48: Triage and Rapid Countermeasures](#hour-24-48-triage-and-rapid-countermeasures)
- [Hour 48-72: Cross-Channel Diversification Buffer](#hour-48-72-cross-channel-diversification-buffer)
- [Documentation and Learning Loop](#documentation-and-learning-loop)
...
Site-wide drops mask which pages lost rankings. Segment impact to identify patterns.
...
- Does the content teach something or rehash what top-ranking competitors already covered?
...
1. **Intro rewrite:** First 150 words must directly answer the title question. No preamble. No "in this article we'll explore." the answer.
...
5. **Helpful content markers:** Add "Key Takeaways" box at top. Add "Common Mistakes" section. Add FAQ with 5 questions readers ask.
...
Thin content drags down site-wide quality scores. **Panda Update** (2011) and its successors evaluate overall site quality, not individual pages.
...
1. **Publication date update:** Change article publication date to current date ONLY IF you've made substantial updates. Don't change the date.
...
* **Hour 0-6: Detection and Impact Quantification:** Algorithm update response begins before Google announces anything.
* **Hour 24-48: Triage and Rapid Countermeasures:** You have impact data and root cause hypothesis.
* **Hour 48-72: Cross-Channel Diversification Buffer:** Algorithm updates prove platform dependence risk.
