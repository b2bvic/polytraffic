...
- [The Email Subscriber LTV Formula](#the-email-subscriber-ltv-formula)
- [Email Subscriber LTV Benchmarks (2024)](#email-subscriber-ltv-benchmarks-2024)
- [Components of Subscriber LTV](#components-of-subscriber-ltv)
- [Calculating Cost Per Subscriber (CPS)](#calculating-cost-per-subscriber-cps)
- [Increasing Subscriber LTV](#increasing-subscriber-ltv)
- [Case Study: Publisher Increases LTV from $0.80 to $4.20](#case-study-publisher-increases-ltv-from-0-80-to-4-20)
- [Tools for LTV Calculation](#tools-for-ltv-calculation)
...
let's use the **correct industry-standard formula**:
...
- **Open rate**: 22%
- **CTR**: 3.5% (of total list, not opens)
...
But we want **per-subscriber LTV** (not active):
...
****: Not every subscriber generates revenue every campaign. Only **openers + clickers** do. So:
...
* **Email Subscriber LTV Benchmarks (2024):** A publisher with $8 RPM from ads and $0.40 per click from affiliates (10% of visitors click affiliate links):
* **Components of Subscriber LTV:** A publisher with $8 RPM from ads and $0.40 per click from affiliates (10% of visitors click affiliate links):
* **Increasing Subscriber LTV:** Convert 10-15% of free subscribers to paid:
