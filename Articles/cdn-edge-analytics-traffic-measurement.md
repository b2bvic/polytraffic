...
- [CDN Edge Logs vs Client-Side Analytics: Understanding the Gap](#cdn-edge-logs-vs-client-side-analytics-understanding-the-gap)
- [Implementing CDN Analytics Across Major Providers](#implementing-cdn-analytics-across-major-providers)
- [Analyzing Edge Data for Bot Traffic and Anomaly Detection](#analyzing-edge-data-for-bot-traffic-and-anomaly-detection)
- [Building Hybrid Analytics: Combining Edge and Client-Side Data](#building-hybrid-analytics-combining-edge-and-client-side-data)
...
2. Select service
3. Go to **Observability → Real-time analytics**
...
Go to **Observability → Historical stats**:
...
2. Select bot protection level:
   - **Off:** Allow all
   - **off:** Allow verified bots + humans
...
* **CDN Edge Logs vs Client-Side Analytics: Understanding the Gap:** Two measurement layers capture different realities.
* **Analyzing Edge Data for Bot Traffic and Anomaly Detection:** Edge logs expose non-human traffic client-side analytics miss.
* **Building Hybrid Analytics: Combining Edge and Client-Side Data:** Neither edge nor client-side analytics alone tell full story.
