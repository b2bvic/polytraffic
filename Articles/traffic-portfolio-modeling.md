...
- [Portfolio Theory Fundamentals Applied to Traffic](#portfolio-theory-fundamentals-applied-to-traffic)
- [Risk Scoring Framework](#risk-scoring-framework)
- [Efficient Frontier for Traffic Portfolios](#efficient-frontier-for-traffic-portfolios)
- [Building Your Portfolio Model](#building-your-portfolio-model)
- [Stress Testing Your Traffic Portfolio](#stress-testing-your-traffic-portfolio)
...
* **Portfolio Theory Fundamentals Applied to Traffic:** In financial portfolios, expected return is the average annual gain.
* **Risk Scoring Framework:** HHI quantifies concentration by squaring each channel's percentage share and summing the results.
* **Efficient Frontier for Traffic Portfolios:** In financial theory, the efficient frontier represents the set of portfolio allocations that maximize return for each level of risk.
* **Building Your Portfolio Model:** Build a portfolio model in Google Sheets or Excel with these tabs:
* **Stress Testing Your Traffic Portfolio:** Stress testing applies hypothetical disruption scenarios to your current portfolio to quantify vulnerability before the disruption occurs.
