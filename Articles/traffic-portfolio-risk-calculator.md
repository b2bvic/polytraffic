...
- [Calculator Input: Data You Need](#calculator-input-data-you-need)
- [Metric 1: Concentration Risk Score (40% of total risk)](#metric-1-concentration-risk-score-40-of-total-risk)
- [Metric 2: Correlation Risk Score (30% of total risk)](#metric-2-correlation-risk-score-30-of-total-risk)
- [Metric 3: Volatility Risk Score (15% of total risk)](#metric-3-volatility-risk-score-15-of-total-risk)
- [Metric 4: Owned Audience Risk Score (15% of total risk)](#metric-4-owned-audience-risk-score-15-of-total-risk)
- [Total Portfolio Risk Score](#total-portfolio-risk-score)
- [Risk Diagnosis and Remediation Plan](#risk-diagnosis-and-remediation-plan)
- [Advanced Calculation: Monte Carlo Risk Simulation](#advanced-calculation-monte-carlo-risk-simulation)
- [Quick Risk Calculator (5-Minute Version)](#quick-risk-calculator-5-minute-version)
...
No spreadsheets required. follow the formulas, plug in your numbers, and interpret results using the benchmarks provided.
...
**This example**: CV 4.15% → **Risk Score: 5** (low volatility)
...
**Strengths**: Low correlation between channels, stable traffic
...
* **Calculator Input: Data You Need:** Before starting, gather this data from Google Analytics (past 12 months):
* **Metric 1: Concentration Risk Score (40% of total risk):** Where TrafficSharei = (Traffic from Source i / Total Traffic)
* **Metric 2: Correlation Risk Score (30% of total risk):** Where Correlationij = Pearson correlation between Channel i and Channel j
* **Metric 3: Volatility Risk Score (15% of total risk):** Based on individual metric scores, identify remediation priorities:
* **Metric 4: Owned Audience Risk Score (15% of total risk):** Based on individual metric scores, identify remediation priorities:
* **Total Portfolio Risk Score:** Based on individual metric scores, identify remediation priorities:
