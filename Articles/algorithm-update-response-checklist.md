...
- [Hours 0-6: Impact Detection and Quantification](#hours-0-6-impact-detection-and-quantification)
- [Hours 6-12: Root Cause Diagnosis](#hours-6-12-root-cause-diagnosis)
- [Hours 12-24: Emergency Triage and Quick Wins](#hours-12-24-emergency-triage-and-quick-wins)
- [Hours 24-48: Content Depth and Freshness Injection](#hours-24-48-content-depth-and-freshness-injection)
- [Hours 48-72: Backup Channel Activation](#hours-48-72-backup-channel-activation)
- [Hours 72+: Monitoring and Documentation](#hours-72-monitoring-and-documentation)
- [Impact Summary](#impact-summary)
- [Root Cause Hypothesis](#root-cause-hypothesis)
- [Actions Taken (Hours 0-72)](#actions-taken-hours-0-72)
...
This checklist compresses response into actionable hour-by-hour tasks. No theory. No strategy discussion. the specific actions that stop bleeding, identify causes, and activate countermeasures before the update finishes rolling out.
...
Go to: **Performance** > **Date Range Comparison**
...
- ☐ Content teaches something new (not rehashed competitor content)
- ☐ Structured for readers (not keyword stuffing)
- ☐ Would be valuable if discovered via social (not search)
...
* **Hours 0-6: Impact Detection and Quantification:** Go to: Performance > Date Range Comparison
* **Hours 12-24: Emergency Triage and Quick Wins:** For each Tier 1 page, rewrite opening 150 words:
* **Hours 24-48: Content Depth and Freshness Injection:** For each critical page, add substantive content:
* **Hours 72+: Monitoring and Documentation:** Create Google Doc titled "Algorithm Update Response Log [Date]":
