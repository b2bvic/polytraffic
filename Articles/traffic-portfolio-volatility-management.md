...
- [Understanding Volatility: Coefficient of Variation](#understanding-volatility-coefficient-of-variation)
- [Volatility Source Analysis: What Causes Swings?](#volatility-source-analysis-what-causes-swings)
- [Tactical Volatility Reduction Strategies](#tactical-volatility-reduction-strategies)
- [Advanced Technique: Portfolio Rebalancing](#advanced-technique-portfolio-rebalancing)
- [Volatility-Adjusted Performance Metrics](#volatility-adjusted-performance-metrics)
- [Case Study: Volatility Reduction in Action](#case-study-volatility-reduction-in-action)
- [When High Volatility is Acceptable](#when-high-volatility-is-acceptable)
...
- **40% Low-volatility base** (Email, Direct, Evergreen SEO): Lower mean, low variance
...
* **Understanding Volatility: Coefficient of Variation:** Where:
- w = weight (traffic %)
- σ = standard deviation
- ρ = correlation
* **Volatility Source Analysis: What Causes Swings?:** Where:
- w = weight (traffic %)
- σ = standard deviation
- ρ = correlation
* **Tactical Volatility Reduction Strategies:** Publishers who covered both topics had negative correlation between segments, one offset the other.
* **Volatility-Adjusted Performance Metrics:** Traditional metric: Traffic growth rate (month-over-month % increase)
