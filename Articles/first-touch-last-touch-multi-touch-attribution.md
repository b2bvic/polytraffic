...
- [Last-Touch Attribution Mechanics](#last-touch-attribution-mechanics)
- [First-Touch Attribution Mechanics](#first-touch-attribution-mechanics)
- [Multi-Touch Attribution Models](#multi-touch-attribution-models)
- [Channel Performance Under Different Models](#channel-performance-under-different-models)
- [Attribution Windows](#attribution-windows)
- [Dark Social and Attribution Breakdown](#dark-social-and-attribution-breakdown)
- [Implementing Multi-Touch Attribution](#implementing-multi-touch-attribution)
- [Attribution Model Selection Framework](#attribution-model-selection-framework)
- [Budget Allocation Based on Attribution](#budget-allocation-based-on-attribution)
- [Multi-Site Portfolio Attribution](#multi-site-portfolio-attribution)
...
**Mechanism:** Machine learning analyzes thousands of customer journeys to determine which touchpoints influence conversion probability. Credit allocation reflects measured impact.
...
**Click-through vs view-through:** Click-through attribution credits only touchpoints where user clicked. View-through attribution includes impressions (user saw your ad but didn't click, then converted later). View-through inflates channel performance and should be used cautiously.
...
**Scale of problem:** Studies suggest 60-80% of social sharing happens via dark social channels. Publishers using last-touch attribution credit "direct traffic" for conversions that originated from private social sharing.
...
* **Last-Touch Attribution Mechanics:** Frameworks only pay off when they run against your numbers.
* **First-Touch Attribution Mechanics:** Frameworks only pay off when they run against your numbers.
* **Multi-Touch Attribution Models:** Frameworks only pay off when they run against your numbers.
* **Channel Performance Under Different Models:** Frameworks only pay off when they run against your numbers.
* **Attribution Windows:** Frameworks only pay off when they run against your numbers.
* **Dark Social and Attribution Breakdown:** Frameworks only pay off when they run against your numbers.
