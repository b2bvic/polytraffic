...
- [The Publisher Email ROI Formula](#the-publisher-email-roi-formula)
- [Attribution Challenge: Multi-Touch Revenue](#attribution-challenge-multi-touch-revenue)
- [Cost Components (Often Hidden)](#cost-components-often-hidden)
- [Revenue Attribution: Display Ads](#revenue-attribution-display-ads)
- [Revenue Attribution: Affiliate Commissions](#revenue-attribution-affiliate-commissions)
- [Benchmark: Publisher Email ROI by Monetization Model](#benchmark-publisher-email-roi-by-monetization-model)
- [Optimizing ROI: Three Levers](#optimizing-roi-three-levers)
- [Case Study: Publisher Increases Email ROI from 110% to 420%](#case-study-publisher-increases-email-roi-from-110-to-420)
- [Tools for Email ROI Tracking](#tools-for-email-roi-tracking)
...
Go to **Admin → Attribution Settings → Data-driven** (requires 400+ conversions/month).
