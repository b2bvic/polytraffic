...
- [Default GA4 Attribution Problems](#default-ga4-attribution-problems)
- [Accessing Attribution Settings](#accessing-attribution-settings)
- [Attribution Model Selection](#attribution-model-selection)
- [Conversion Window Configuration](#conversion-window-configuration)
- [Reporting Identity Configuration](#reporting-identity-configuration)
- [User ID Implementation](#user-id-implementation)
- [Custom Channel Groupings](#custom-channel-groupings)
- [Conversion Event Configuration](#conversion-event-configuration)
- [Attribution Path Exploration](#attribution-path-exploration)
- [Cross-Domain Tracking](#cross-domain-tracking)
- [Attribution Reports and Analysis](#attribution-reports-and-analysis)
...
**When data is insufficient:** GA4 falls back to last-click attribution without telling you. You think you're running data-driven attribution but seeing last-click results. This credits bottom-funnel channels excessively.
