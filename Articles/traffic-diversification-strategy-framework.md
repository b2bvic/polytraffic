...
- [Core Concept: Traffic Sources as Asset Classes](#core-concept-traffic-sources-as-asset-classes)
- [The Diversification Formula: Calculating Correlation](#the-diversification-formula-calculating-correlation)
- [Portfolio Variance: The Math of Risk Reduction](#portfolio-variance-the-math-of-risk-reduction)
- [Efficient Frontier: Optimal Channel Mix](#efficient-frontier-optimal-channel-mix)
- [Sharpe Ratio: Return per Unit of Risk](#sharpe-ratio-return-per-unit-of-risk)
- [Capital Allocation: The 60/30/10 Rule](#capital-allocation-the-60-30-10-rule)
- [Rebalancing: When to Adjust Allocation](#rebalancing-when-to-adjust-allocation)
- [Correlation Shifts: The Hidden Risk](#correlation-shifts-the-hidden-risk)
- [Black Swan Protection: Tail Risk Hedging](#black-swan-protection-tail-risk-hedging)
- [Implementation Framework: 4-Step Process](#implementation-framework-4-step-process)
- [Advanced Tactics: Factor-Based Diversification](#advanced-tactics-factor-based-diversification)
- [Case Study: Portfolio Optimization in Practice](#case-study-portfolio-optimization-in-practice)
...
- **Email** delivers lower volume but low volatility (your list doesn't disappear overnight) and highest revenue per visit
...
True resilience requires diversification across factors, not channels.
...
* **Core Concept: Traffic Sources as Asset Classes:** In financial portfolio theory, assets are evaluated on two dimensions:
* **The Diversification Formula: Calculating Correlation:** The benefit of diversification comes from correlation, the degree to which two channels move together.
* **Efficient Frontier: Optimal Channel Mix:** The efficient frontier is the set of portfolios that deliver maximum return for a given risk level (or minimum risk for a given return level).
* **Sharpe Ratio: Return per Unit of Risk:** The Sharpe ratio measures risk-adjusted return, how much reward you get for each unit of risk taken.
* **Capital Allocation: The 60/30/10 Rule:** How should you allocate effort across channels?
