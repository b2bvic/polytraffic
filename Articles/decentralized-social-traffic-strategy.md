...
- [The Decentralized Social Landscape](#the-decentralized-social-landscape)
- [Federation Mechanics: How Content Spreads](#federation-mechanics-how-content-spreads)
- [Content Strategy for Decentralized Platforms](#content-strategy-for-decentralized-platforms)
- [Traffic Measurement and Attribution](#traffic-measurement-and-attribution)
- [Building an Audience from Zero](#building-an-audience-from-zero)
- [Case Study: Publisher Migration from Twitter to Fediverse](#case-study-publisher-migration-from-twitter-to-fediverse)
- [Risks and Limitations](#risks-and-limitations)
- [Tools for Decentralized Social Management](#tools-for-decentralized-social-management)
...
2. Share others' content (not your own)
...
* **Federation Mechanics: How Content Spreads:** When you post on Mastodon, the post is pushed to:
* **Content Strategy for Decentralized Platforms:** Use 3-5 hashtags per post, placed at the end.
* **Building an Audience from Zero:** Your server determines your Local timeline, the community you're embedded in.
* **Case Study: Publisher Migration from Twitter to Fediverse:** A cybersecurity newsletter with 12K Twitter followers and declining reach (impressions dropped 48% in 2024) migrated to the fediverse:
