...
- [Understanding Correlation: The Mathematical Foundation](#understanding-correlation-the-mathematical-foundation)
- [Correlation Matrix: Common Traffic Source Pairs](#correlation-matrix-common-traffic-source-pairs)
- [Why Channels Correlate: Shared Failure Modes](#why-channels-correlate-shared-failure-modes)
- [Building Uncorrelated Portfolios: The Three-Layer Strategy](#building-uncorrelated-portfolios-the-three-layer-strategy)
- [Portfolio Stress Testing: Simulating Failures](#portfolio-stress-testing-simulating-failures)
- [Negative Correlation: The Holy Grail (Rarely Achievable)](#negative-correlation-the-holy-grail-rarely-achievable)
- [Advanced Technique: Dynamic Correlation Monitoring](#advanced-technique-dynamic-correlation-monitoring)
- [Uncorrelated Channel Combinations: Top 10 Pairs](#uncorrelated-channel-combinations-top-10-pairs)
...
- **r >0.80**: high (same source, no diversification)
...
The matrix below is an illustrative example, not the result of a verified publisher cohort. Calculate the coefficients from your own weekly channel data before using them for allocation decisions.
