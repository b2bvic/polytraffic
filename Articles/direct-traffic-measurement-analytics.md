...
> **Quick Summary**
> - **What this covers:** Direct traffic conflates typed URLs, dark social, and broken tracking. Learn forensic methods to segment true direct traffic and recover attribution accuracy.
> - **Who it's for:** traffic strategists and growth operators
> - **Key takeaway:** Read the first section for the core framework, then use the specific tactics that match your situation.

- [Why Analytics Platforms Misclassify Direct Traffic](#why-analytics-platforms-misclassify-direct-traffic)
- [Forensic Method 1: Landing Page Analysis](#forensic-method-1-landing-page-analysis)
- [Forensic Method 2: Device and Browser Signals](#forensic-method-2-device-and-browser-signals)
- [Forensic Method 3: Session Depth and Duration](#forensic-method-3-session-depth-and-duration)
- [Forensic Method 4: Time-to-First-Session](#forensic-method-4-time-to-first-session)
- [Correcting Direct Traffic Attribution](#correcting-direct-traffic-attribution)
- [Case Study: Publisher Attribution Recovery](#case-study-publisher-attribution-recovery)
- [Tools for Direct Traffic Forensics](#tools-for-direct-traffic-forensics)
...
Go to **Reports → Engagement → Landing Page**, filter **Source = (direct)**:
...
Go to **Reports → Tech → Tech Details**, filter **Source = (direct)**:
...
* **Why Analytics Platforms Misclassify Direct Traffic:** When a user clicks a link, the originating URL is sent in the HTTP Referer [sic] header.
* **Forensic Method 1: Landing Page Analysis:** Go to Reports → Engagement → Landing Page, filter Source = (direct):
* **Forensic Method 2: Device and Browser Signals:** Go to Reports → Tech → Tech Details, filter Source = (direct):
* **Forensic Method 3: Session Depth and Duration:** Use BigQuery Export (free for GA4) to query:
* **Forensic Method 4: Time-to-First-Session:** Create a custom dimension to capture first-touch source:
