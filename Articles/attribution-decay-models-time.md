...
- [Time Decay Attribution Mechanics and Half-Life Parameters](#time-decay-attribution-mechanics-and-half-life-parameters)
- [Channel Valuation Differences Across Decay Models](#channel-valuation-differences-across-decay-models)
- [Implementing Custom Decay Models in Analytics Platforms](#implementing-custom-decay-models-in-analytics-platforms)
- [Common Decay Model Mistakes and Corrections](#common-decay-model-mistakes-and-corrections)
- [Advanced: Position-Based Decay Hybrids](#advanced-position-based-decay-hybrids)
...
**Reality:** Direct mail drove conversion. Customer saw ad initially but didn't act until direct mail reminded them.
...
- Early touchpoints get excess credit for decisions that were made quickly
...
* **Time Decay Attribution Mechanics and Half-Life Parameters:** Time decay attribution applies exponential decay functions to reduce credit as time between touchpoint and conversion increases.
* **Channel Valuation Differences Across Decay Models:** Decay model selection changes which channels appear valuable.
* **Implementing Custom Decay Models in Analytics Platforms:** Most platforms offer limited decay customization.
* **Common Decay Model Mistakes and Corrections:** Time decay attribution introduces specific failure modes.
* **Advanced: Position-Based Decay Hybrids:** Sophisticated models combine time decay with position-based credit.
