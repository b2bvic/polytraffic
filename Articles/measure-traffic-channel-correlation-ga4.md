...
- [Understanding GA4 Attribution](#understanding-ga4-attribution)
- [Tool 1: Conversion Paths Report](#tool-1-conversion-paths-report)
- [Tool 2: Model Comparison](#tool-2-model-comparison)
- [Tool 3: Path Exploration](#tool-3-path-exploration)
- [Cohort Analysis for Correlation](#cohort-analysis-for-correlation)
- [Time Lag Analysis](#time-lag-analysis)
- [Cross-Channel Influence Report](#cross-channel-influence-report)
- [Practical Application: Budget Reallocation](#practical-application-budget-reallocation)
...
The **Conversion Paths** report shows the sequence of touchpoints users handle before converting.

### Accessing the Report

1. Go to **GA4 → Advertising → Attribution → Conversion Paths**
...
1. Go to **GA4 → Advertising → Attribution → Model Comparison**
...
**Paid Social massively under-credited by Last Click:** Appears early in journeys, rarely as last touch. DDA reveals Paid Social drives 1,200 conversions' worth of value (initial awareness), not 400.
...
1. Go to **GA4 → Explore → Create new exploration → Path Exploration**
...
**Organic Search → Direct:** 3,000 users (37.5% of Organic traffic) handle directly after initial organic visit. Strong retention signal.
...
**Direct (1 day):** Shortest lag, users handling directly are already decided.
