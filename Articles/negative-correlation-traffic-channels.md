...
> **Quick Summary**
> - **What this covers:** How to identify traffic channels that cannibalize each other, measure the substitution effect, and optimize budget allocation when channels compete for the same audience.
> - **Who it's for:** traffic strategists and growth operators
> - **Key takeaway:** Read the first section for the core framework, then use the specific tactics that match your situation.

- [How Negative Correlation Manifests](#how-negative-correlation-manifests)
- [Identifying Negative Correlation](#identifying-negative-correlation)
- [Common Negative Correlation Pairs](#common-negative-correlation-pairs)
- [Optimization Strategies](#optimization-strategies)
- [Calculating True Incremental Value](#calculating-true-incremental-value)
- [When to Accept Negative Correlation](#when-to-accept-negative-correlation)
...
- `Social → Email → Direct` (social reminds user, they handle directly later)
...
Ignoring cannibalization makes Paid Search appear twice as cost-effective as it is.
...
* **How Negative Correlation Manifests:** Negative correlation appears in three primary patterns:
* **Common Negative Correlation Pairs:** Certain channel combinations frequently exhibit cannibalization:
* **Optimization Strategies:** Once negative correlation is identified, optimize budget allocation.
* **Calculating True Incremental Value:** Standard attribution credits Channel A with all traffic where it's the last touchpoint.
