...
- [The Core Question: Is This Traffic Portfolio Antifragile?](#the-core-question-is-this-traffic-portfolio-antifragile)
- [Stage 1: Traffic Source Inventory (Surface Analysis)](#stage-1-traffic-source-inventory-surface-analysis)
- [Stage 2: Correlation Analysis (Hidden Risk Detection)](#stage-2-correlation-analysis-hidden-risk-detection)
- [Stage 3: Platform Dependency Risk Audit](#stage-3-platform-dependency-risk-audit)
- [Stage 4: Revenue Quality Analysis](#stage-4-revenue-quality-analysis)
- [Stage 5: Growth Trajectory vs. Maintenance Requirements](#stage-5-growth-trajectory-vs-maintenance-requirements)
- [Stage 6: Email List Quality Assessment](#stage-6-email-list-quality-assessment)
- [Stage 7: Technical Infrastructure Audit](#stage-7-technical-infrastructure-audit)
- [Stage 8: Competitive and Market Risk Assessment](#stage-8-competitive-and-market-risk-assessment)
- [Stage 9: Seller Motivation and Transparency](#stage-9-seller-motivation-and-transparency)
- [Stage 10: Valuation Adjustment Framework](#stage-10-valuation-adjustment-framework)
- [Post-Acquisition Diversification Plan](#post-acquisition-diversification-plan)
...
**Antifragile traffic** doesn't survive shocks, it benefits from volatility. When Google updates, YouTube algorithm changes, or social platforms shift priorities, an antifragile portfolio maintains or improves total traffic.
...
3. **Revenue by traffic source** (not visits, some sources deliver 5× higher value)
...
**Buyer's advantage**: Sellers rarely calculate correlations. If you do this analysis and discover 0.70 correlation between what seller calls "diversified sources," you have negotiating advantage.
...
**Takeaway**: Demand complete traffic history (24-36 months minimum), not the "good period."
...
No. Mono-channel sites can be excellent acquisitions if priced appropriately. adjust valuation to reflect concentration risk. A $200K "diversified" site with hidden correlation might be worse than a $80K mono-channel site priced honestly.
