...
> **Quick Summary**
> - **What this covers:** Different traffic sources generate drastically different revenue per visit. Calculate true profitability by measuring revenue, conversion rates, and lifetime value across channels.
> - **Who it's for:** traffic strategists and growth operators
> - **Key takeaway:** Read the first section for the core framework, then use the specific tactics that match your situation.

- [Why Revenue Per Visitor Varies by Channel](#why-revenue-per-visitor-varies-by-channel)
- [Measuring Revenue Per Visitor by Channel](#measuring-revenue-per-visitor-by-channel)
- [Channel RPV Benchmarks](#channel-rpv-benchmarks)
- [Optimizing Revenue Per Visitor](#optimizing-revenue-per-visitor)
...
**Track:** Revenue generated by this cohort over next 12 months (not first visit)
...
- Month 2 revenue: $625 ($0.05 RPV, low return rate)
...
**One-shot channels (paid ads, influencer posts) show minimal LTV growth:** Most revenue comes from first visit, few return visitors.
...
* **Why Revenue Per Visitor Varies by Channel:** Three factors drive revenue differences across sources.
* **Measuring Revenue Per Visitor by Channel:** Quantify profitability across traffic sources.
* **Channel RPV Benchmarks:** Expected revenue per visitor by traffic source.
...
Depends on profitability, not RPV alone. Low RPV + high volume can be profitable if cost per visit is lower than RPV. Example: Social traffic at $0.18 RPV with $0.12 CPV = $0.06 margin × 50,000 visits = $3,000 profit/month. Higher RPV channel ($0.90 RPV) with higher cost ($0.95 CPV) = -$0.05 margin = unprofitable. Evaluate (RPV - CPV) × Volume, not RPV.
