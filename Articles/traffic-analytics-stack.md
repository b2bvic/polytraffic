...
- [The Analytics Stack Architecture](#the-analytics-stack-architecture)
- [Google Analytics 4 Configuration for Multi-Channel Tracking](#google-analytics-4-configuration-for-multi-channel-tracking)
- [UTM Taxonomy: The Foundation of Multi-Channel Attribution](#utm-taxonomy-the-foundation-of-multi-channel-attribution)
- [Privacy-Compliant Analytics: Plausible and Fathom](#privacy-compliant-analytics-plausible-and-fathom)
- [Building the Portfolio Dashboard](#building-the-portfolio-dashboard)
- [Server-Side Tracking: The Next Evolution](#server-side-tracking-the-next-evolution)
...
* **The Analytics Stack Architecture:** A complete multi-channel analytics stack has three layers, each serving distinct decision needs.
* **Google Analytics 4 Configuration for Multi-Channel Tracking:** GA4's event-based model provides powerful multi-channel tracking when configured correctly.
* **UTM Taxonomy: The Foundation of Multi-Channel Attribution:** UTM parameters are the connective tissue between your channels and your analytics.
* **Privacy-Compliant Analytics: Plausible and Fathom:** Ad blockers block Google Analytics on 25-40% of visits according to PageFair data.
* **Building the Portfolio Dashboard:** Create a master dashboard in Google Looker Studio (free) that combines data from all stack layers:
* **Server-Side Tracking: The Next Evolution:** Browser-based analytics (GA4, Plausible, Fathom) all depend on JavaScript executing in the user's browser.
