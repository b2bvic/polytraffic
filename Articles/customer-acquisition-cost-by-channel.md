---
title:: Customer Acquisition Cost by Channel: CAC Benchmarks for Organic, Paid, Social, and Referral
description:: Compare customer acquisition costs across organic search, paid ads, social media, and referral channels with 2025-2026 benchmark data from HubSpot, ProfitWell, and SEMrush.
...
- [CAC vs. CPV: Why Both Metrics Matter](#cac-vs-cpv-why-both-metrics-matter)
- [Channel-Level CAC Benchmarks](#channel-level-cac-benchmarks)
- [CAC Benchmarks by Business Model](#cac-benchmarks-by-business-model)
- [Reducing CAC Across Channels](#reducing-cac-across-channels)
- [CAC Optimization Case Studies](#cac-optimization-case-studies)
...
A channel with $0.50 true CPV and 2% conversion rate produces $25 CAC.
A channel with $0.15 true CPV and 0.5% conversion rate produces $30 CAC.
...
Referral channels (partnerships, affiliate programs, podcast guesting, community) produce highly variable but often efficient customer acquisition:
...
- New channel mix: 35% organic ($120 CAC), 25% paid search ($180 CAC), 15% email ($30 CAC), 15% paid social ($220 CAC), 10% referral ($60 CAC)
- Blended CAC: $99 (down 45% from $180)
- Total customer volume maintained (reallocated, not reduced)
...
* **CAC vs. CPV: Why Both Metrics Matter:** Cost per visitor (CPV) measures traffic acquisition efficiency.
* **Channel-Level CAC Benchmarks:** Organic search CAC drops 40-60% between year 1 and year 3 of consistent investment.
* **CAC Benchmarks by Business Model:** Source: ProfitWell SaaS Benchmarks 2025, First Page Sage CAC Study
* **CAC Optimization Case Studies:** The reduction came from three levers: shifting volume toward lowest-CAC channels, optimizing existing channels for conversion rate, and adding a new low-CAC channel (referral partnerships).
