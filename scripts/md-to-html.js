...
function buildArticleHTML(title, description, body, slug, date) {
  ...
  const jsonLd = JSON.stringify({
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": `https://polytraffic.com/articles/${slug}.html`
    }
  }, null, 2);
...
<head>
    ...
    <title>${title} | Polytraffic</title>
    <meta name="description" content="${description}" />
    <meta name="author" content="Victor Valentine Romo" />
    <meta property="og:title" content="${title}" />
    <meta property="og:description" content="${description}" />
    <meta property="og:type" content="article" />
    <meta property="og:url" content="https://polytraffic.com/articles/${slug}.html" />
    <meta property="og:site_name" content="Polytraffic" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="${title}" />
    <meta name="twitter:description" content="${description}" />
    <link rel="canonical" href="https://polytraffic.com/articles/${slug}.html" />
${entityLinks}
