    ...
    <section class="max-w-6xl mx-auto px-6 py-8">
      <div class="pt-cta-box">
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div>
            <h3 class="font-display font-bold text-xl text-slate-100">Want this handled instead of studied?</h3>
            <p class="mt-2 text-slate-400 text-sm">Scale With Search builds the traffic and search system this research describes, scoped to your operation.</p>
          </div>
